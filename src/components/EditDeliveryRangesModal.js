...
const EditDeliveryRangesModal = ({ onClose, range }) => {
    ...
    const [{ data: updateData, error: updateError, loading: updateLoading }, updateRange] = useAxios({ url: `/delivery-methods/delivery-ranges/${rangeFormData?.id}`, method: 'PUT' }, { manual: true, useCache: false });
...
export default EditDeliveryRangesModal;